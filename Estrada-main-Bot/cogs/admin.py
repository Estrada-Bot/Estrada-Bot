...
# ─── custom emojis (uploaded by ghostx_1x on the Estrada server) ───
# ─── emojis used in mod-log messages — real Estrada emojis (resolved live
# from Application Emojis by name); unicode only kicks in if that emoji
# isn't loaded/found. "ban" has no matching custom emoji uploaded yet, so
# it stays on 🚫 until one exists — tell me the real name once you upload
# it and I'll wire it in. ─────────────────────────────────────────────────
EMOJI = emoji_loader.TextEmojiMap({
    "ban": (None, "🚫"),
    "unban": ("60226check", "✅"),
    ...
    "lock": ("87233lockids", "🔒"),
    "unlock": ("9068ouvert", "🔓"),
    "clear": ("14385supprimer", "🧹"),
    "nuke": ("14385supprimer", "💣"),
    "slowmode": ("29561settings", "🐢"),
    "role_add": ("85722ajouter", "➕"),
    "role_remove": ("67516moins", "➖"),
    "nickname": ("11569crayon", "✏️"),
    "success": ("60226check", "✅"),
    "error": ("8118xmark", "❌"),
})
