...
# ─── emojis used in giveaway messages — real Estrada emojis (resolved live
# from Application Emojis by name), unicode only as last-resort fallback ────
EMOJI = emoji_loader.TextEmojiMap({
    "gift": ("834134giftingchampion", "🎁"),
    "enter": ("763237giftingicon", "🎉"),
    "winner": ("158897crown", "👑"),
    "reroll": ("8997modernrefresh", "🔁"),
    "success": ("60226check", "✅"),
    "error": ("8118xmark", "❌"),
    ...
    def _build(self, *, ended: bool = False, decision_text: str = None, accent: int = None):
        ...
        if ended:
            ...
            btn = discord.ui.Button(
                ...
                emoji=emoji_loader.get_obj("834134giftingchampion") or "🎉",
